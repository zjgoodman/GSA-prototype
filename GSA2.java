...
public class GSA{
	...
	private static GSAFrame frame;
	public static Store store;
	public static EmployeeManager empMngr;
	...
	public static Week readAvailability(){
		Week w = new Week();
		for (int d=0;d<7;d++){
	...
	public static void writeShifts(){
		Schedule sch = store.schedule;
		for (int i = 0; i<7;i++){
			WorkDay day = sch.days[i];
	...
	public static void writeAvailability(Week w){
		for (int d = 0; d<7;d++){
	...
	public static void run(){
		...
		} while(empMngr.running());
	}

	public static void main(String[] args){
		System.out.println("GSA v0.1");
